  ...
  <div >
	...
	<div class="modal-content" id="content">
		...
		<div class="modal-body">
			<form class="col-md-12 center-block" method="post" action="insert.php">
				<div class="form-group">
					<input type="text" class="form-control input-lg" placeholder="first name" name="fname">
					
				</div>
				<div class="form-group">
					<input type="text" class="form-control input-lg" placeholder="second name" name="sname">
        ...
        <div class="form-group">
          <input type="text" class="form-control input-lg" placeholder="Phone number" name="pno">
